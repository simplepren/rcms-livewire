<div>
    ...
    <div class="flex justify-between px-4">
        <div class="p-2"><span class="text-xl text-gray-600 font-semibold">UPLOAD DATA BERKAS</span></div>
            ...
            <div class="lg:w-1/2 w-fulll">
                <div class="mb-5">
                    ...
                    <ul class="text-sm text-gray-500 list-disc list-inside dark:text-gray-400">
                        <li>Download template/form daftar berkas <button wire:click="downloadFile" class="text-blue-600 hover:underline">disini</button></li>
                        ...
                        <li>Adapun kolom yang wajib diisi (tidak boleh NULL) adalah:
                            <ol class="ps-5 list-decimal list-inside">
                                ...
                                <li>Aktif</li>
                                <li>Inaktif</li>
                                <li>Keterangan Musnah</li>
                            </ol>
                        </li>
                        <li>Nomor berkas harus urut, dan pastikan tidak boleh ada duplikasi nomor berkas dengan Aplikasi. Cek nomor berkas terakhir pada aplikasi.</li>
                        <li>Kolom unit pengolah berisi kode unit, silakan hubungi admin untuk mengetahui kode unit</li>
                    </ul>
                </div>
                <div
                    class="mb-4"
                ...
                >
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">File Daftar Berkas</label>
