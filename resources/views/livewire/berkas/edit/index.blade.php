<div>
    ...
    <div class="flex justify-between px-4">
        <div class="p-2"><span class="text-xl text-gray-600 font-semibold">EDIT BERKAS</span></div>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                  ...
                  <li aria-current="page">
                    <div class="flex items-center">
                      ...
                      <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Edit Berkas</span>
                    </div>
                  </li>
                </ol>
            </nav>
    ...
    <div class="p-5 bg-white rounded-sm">
        <form wire:submit.prevent="formEdit">
            ...
            <div class="md:flex md:gap-10 block mb-3">
                <div class="md:w-1/2 w-full">
                    <div class="mb-3">
                        <h4 class="text-lg font-semibold">Lokasi Simpan Sementara</h4>
                    </div>
                ...
                <div class="md:w-1/2 w-full">
                    <div class="mb-3">
                        <h4 class="text-lg font-semibold">Lokasi Simpan Definitif</h4>
                    </div>
                    <div class="flex gap-3">
                        <div class="md:w-3/12 w-full mb-2">
                            <div class="flex gap-2">
                        ...
                        <div class="md:w-1/12 w-full mb-2">
                            <label for="" class="label label-sm">Boks</label>
                            <input wire:model="boks" type="text" class="input input-bordered"/>
                        </div>
                        <div class="md:w-1/12 w-full mb-2">
                            <label for="" class="label label-sm">Folder</label>
                            <input wire:model="folder" type="text" class="input input-bordered"/>
                        </div>
                    </div>
                </div>
            </div>
