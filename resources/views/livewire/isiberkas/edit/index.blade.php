<div>
    <div wire:loading wire:target="formEditArsip, resetForm, kembali" class="fixed left-0 top-0 bg-white opacity-75 text-center w-full h-full" style="z-index: 51">
    ...
    <div class="flex justify-between px-4">
        <div class="p-2"><span class="text-xl text-gray-600 font-semibold">EDIT ISI BERKAS</span></div>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                  ...
                  <li>
                    <div class="flex items-center">
                      ...
                      <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Edit Isi Berkas</a>
                    </div>
                  </li>
                </ol>
            </nav>
    ...
    <div class="p-5 bg-white rounded-sm">
        <form wire:submit.prevent="formEditArsip">
            <div class="md:flex md:gap-10 block mb-3">
                <div class="md:w-1/2 w-full">
                    <div class="relative mb-3 w-full" x-data="selectConfigs1()"  @click.away="close()">
                        <label class="label label-sm">No. Berkas</label>
                        <input wire:model="no_berkas" type="text" class="input input-bordered" disabled/>
                    </div>
                    ...
                    <div class="mb-3 md:flex md:gap-3 block w-full">
                        <div class="mb-3 w-full md:w-1/5">
                            ...
                            <input wire:model="no_item" type="text" class="input input-bordered"/>
                            @error('no_item')
                                <p class="text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
