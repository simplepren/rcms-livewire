<div>
    <form wire:submit.prevent="formPindahkan">
        ...
        <div class="flex w-full mb-2">
            ...
            <div class="w-3/4">
                <input type="text" wire:model="uraian_berkas" class="input input-bordered">
            </div>
        </div>
        <div class="flex w-full mb-2">
            <div class="w-1/4 flex items-center">Unit Pengolah</div>
            <div class="w-3/4">
                <input type="text" wire:model="unit_pengolah" class="input input-bordered">
            </div>
        </div>
        <div class="flex w-full mb-2">
            <div class="w-1/4 flex items-center">Kode Klasifikasi</div>
            <div class="w-3/4">
                <input type="text" wire:model="klasifikasi" class="input input-bordered">
            </div>
        </div>
        <div class="flex w-full mb-2">
            <div class="w-1/4 flex items-center">Jenis Arsip</div>
            <div class="w-3/4">
                <input type="text" wire:model="jenis_arsip" class="input input-bordered">
            </div>
        </div>
