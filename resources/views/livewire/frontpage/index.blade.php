...
new
#[Layout('layouts.layout-frontpage')]

class extends Component {

    public function login_rcms()
    {
    ...
    <div class="flex justify-center px-1">
        <div class="py-2 w-full sm:max-w-7xl bg-slate-200">
            <div class="md:flex md:justify-between hidden">
                ...
                <div class="p-6 w-40 bg-gray-200">
                    <button wire:click="login_rcms" class="px-2 py-1 rounded-md bg-slate-500 text-white hover:bg-slate-600 text-sm">Login RCMS</button>
                </div>
            </div>
